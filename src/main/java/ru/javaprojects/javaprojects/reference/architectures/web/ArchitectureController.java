...
import ru.javaprojects.javaprojects.reference.architectures.ArchitectureTo;

import static ru.javaprojects.javaprojects.reference.architectures.ArchitectureUtil.asTo;
...
public class ArchitectureController {
    ...
    public String createOrUpdate(@Valid ArchitectureTo architectureTo, BindingResult result, Model model,
        ...
        if (result.hasErrors()) {
            if (architectureTo.getLogo() != null) {
                architectureTo.getLogo().keepInputtedFile(FileTo.IS_IMAGE_FILE, () -> architectureTo.setLogo(null));
            }
            if (!isNew) {
