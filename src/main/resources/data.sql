...
INSERT INTO technologies(name, url, usage, file_name, file_link)
VALUES ('Java', 'https://www.oracle.com/java', 'BACKEND', 'java.svg', 'content/technologies/java/java.svg'),
       ('Spring', 'https://spring.io', 'BACKEND', 'spring.svg', 'content/technologies/spring/spring.svg'),
       ('Angular', 'https://angular.dev', 'FRONTEND', 'angular.svg', 'content/technologies/angular/angular.svg');
