package ru.javaprojects.javaprojects.users.web;
...
import static ru.javaprojects.javaprojects.common.CommonTestData.HOME_URL;
import static ru.javaprojects.javaprojects.common.CommonTestData.NOT_EXISTING_ID;
import static ru.javaprojects.javaprojects.users.UserTestData.ADMIN_ID;
import static ru.javaprojects.javaprojects.users.UserTestData.ADMIN_MAIL;
import static ru.javaprojects.javaprojects.users.UserTestData.AVATARS_TEST_CONTENT_FILES_PATH;
import static ru.javaprojects.javaprojects.users.UserTestData.ENABLED_PARAM;
import static ru.javaprojects.javaprojects.users.UserTestData.INVALID_PASSWORD;
import static ru.javaprojects.javaprojects.users.UserTestData.NEW_PASSWORD;
import static ru.javaprojects.javaprojects.users.UserTestData.PASSWORD_PARAM;
import static ru.javaprojects.javaprojects.users.UserTestData.USER_ID;
import static ru.javaprojects.javaprojects.users.UserTestData.USER_MAIL;
import static ru.javaprojects.javaprojects.users.UserTestData.admin;
import static ru.javaprojects.javaprojects.users.UserTestData.user;
import static ru.javaprojects.javaprojects.users.web.LoginController.LOGIN_URL;
import static ru.javaprojects.javaprojects.users.web.UserManagementController.USERS_URL;
