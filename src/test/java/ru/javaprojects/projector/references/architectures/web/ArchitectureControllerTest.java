...
import static ru.javaprojects.projector.references.architectures.ArchitectureTestData.*;
...
class ArchitectureControllerTest extends AbstractControllerTest {
    private static final String ARCHITECTURES_VIEW = "references/architectures";
    private static final String ARCHITECTURES_ADD_FORM_URL = ARCHITECTURES_URL + "/add";
    private static final String ARCHITECTURE_FORM_VIEW = "references/architecture-form";
